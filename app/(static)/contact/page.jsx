...
function Contact() {
  ...
  <div className="p-8 md:p-12 lg:px-16 lg:py-24">
    ...
    <div className="mx-auto mt-8 max-w-xl">
      <form action="#" className="sm:flex flex-col sm:gap-4">
        ...
        <button
          type="submit"
          className="group mt-4 flex w-full items-center justify-center gap-2 rounded-md bg-yellow-400 px-5 py-3 text-white transition focus:ring-3 focus:ring-yellow-400 focus:outline-hidden sm:mt-0 sm:w-auto"
        >
